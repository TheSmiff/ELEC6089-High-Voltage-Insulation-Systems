...
\begin{figure}[!htb]
  ...
  \subfigure[Wide View]{
      ...
      \includegraphics[height = 6cm]{../Matlab_Calculations/Matlab_David/2DRadial.eps} 
  	\label{Figure:21plot2}    
  }
  \subfigure[Real Perspective]{
  \includegraphics[width=\textwidth,height = 10cm ]{../Matlab_Calculations/Matlab_David/Designeactualsize.eps} 
