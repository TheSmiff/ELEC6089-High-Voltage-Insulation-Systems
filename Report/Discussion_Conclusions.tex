...
\subfigure[Location of Cut Plane(s)]{
    \includegraphics[width = 0.162\textwidth]{./Figures/CutLocation_Axial_NoFoil.pdf} 
	%\caption{Normal Electric Field (V/m) for the No-Grading Model}
	\label{Figure:Cut_NoFoil_Axial}
   } 
\subfigure[The Axial Electric field along the bushing surface]{
    \includegraphics[width = 0.45\textwidth]{./Figures/MatlabFigs/No_Foil_Surface_AxialField.eps} 
	%\caption{Normal Electric Field (V/m) for the No-Grading Model}
...
\ref{Figure:Nofoilsaxialfield} shows the axial field strength along the surface of the bushing and expands upon \ref{Figure:problemfield}. As is understood it is axial field that generates surface discharge and the closer the field to ground the more likely the breakdown is to be fatal. Additionally the electric field is above the PD inception within air, not considering the radial field component, this makes localised corona discharge very likely.
...
\subfigure[The No Grading Model Fails PD Criteria]{
    \includegraphics[width = 0.50\textwidth]{./Figures/MatlabFigs/NormEfieldinnograding.eps} 
	%\caption{Normal Electric Field (V/m) for the No-Grading Model}
...
This is best illustrated in \ref{Figure:Nogradaxialfield}, where the concentrations of axial field have migrated to a point much further from ground. Having no grading is clearly an unsatisfying solution, local concentrations of field leading to many PDs, but it does show a solution and effect of basic field shaping. Presence of the foils has shaped the field to a great degree, moving the field concentration up to the vertical edge of the outermost foil, however in doing so, and without a gradient present the axial field is not steadily reduced. 
...
\begin{figure}[!h]
  \centering
\subfigure[Location of Cut Plane(s)]{
    \includegraphics[width = 0.18\textwidth]{./Figures/CutLocation_Axial_NoGrading.pdf} 
	%\caption{Normal Electric Field (V/m) for the No-Grading Model}
...
Finally, the electric potential across the foils is analysed.
