...
\begin{figure}[!h]
  \centering
    \includegraphics[width = 0.8\textwidth]{./Figures/MatlabFigs/NormEfieldinnograding.eps} 
\caption{Anotherfigure}
\label{Figure:NoFoilsFail}
\end{figure}
...
\begin{figure}[!h]
\centering
\includegraphics[width = 0.75\textwidth]{R-field.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.9\textwidth]{ConstantAxialField.eps}
...
From the results shown in the previous sections, the radial graded design would perform better in this specific case. The graph show the variation in radial electric field shows the peak radial electric field for the axial graded design exceeds the limit of 4.5kV/mm
