...
\begin{figure}[!h]
	\centering
	\includegraphics[width=\textwidth]{./Figures/MatlabFigs/No_Foils_Surface_AxialField.eps}
	\caption{The Axial Electric field along the bushing surface}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=\textwidth]{./Figures/MatlabFigs/No_Grading_Surface_AxialField.eps}
	\caption{The Axial Electric field along the bushing surface}
	\label{Figure:Nofoilsaxialfield}
	\end{figure}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=\textwidth]{./Figures/MatlabFigs/No_Grading_Electric_Potential.eps}
