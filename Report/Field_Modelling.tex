...
\begin{figure}[!h]
  \centering
    \includegraphics[width = \textwidth]{./Figures/Simulations/Edited_No_Foils_Large/Geometry.eps} 
...
\begin{figure}[!h]
  \centering
    \includegraphics[width = \textwidth]{./Figures/Simulations/Edited_No_Foils_Large/Meshing.eps} 
...
\begin{figure}[!h]
  \centering
    \includegraphics[width = \textwidth]{./Figures/Simulations/Edited_No_Foils_Large/Norm_E_Field.eps} 
...
\subsection{No Foils}
In order to illustrate the requirement for capacitive grading within AC bushings, a simulation of a bushing with no grading was conducted, as shown in figure \ref{Figure:No_Foil}. Figure \ref{Figure:No_Foil_Geom} shows the geometry and materials used for each section.
...
\begin{figure}[!h]
  \centering
  \subfigure[Geometry and materials]{
    \includegraphics[height = 14cm]{./Figures/Simulations/Edited_No_Foils_Final/Geometry.png} 
	\label{Figure:No_Foil_Geom}
  }
  \subfigure[Meshing]{
    \includegraphics[height = 14cm]{./Figures/Simulations/Edited_No_Foils_Final/Mesh.png} 
	\label{Figure:No_Foil_Mesh}
  }
\subfigure[Normal Electric Field (V/m)]{
    \includegraphics[height = 14cm]{./Figures/Simulations/Edited_No_Foils_Final/E_Field_Norm.png} 
	\label{Figure:No_Foil_Field}
  }
\caption{No Foil Simulation - X and Y axis are dimensions in mm}
  \label{Figure:No_Foil}
\end{figure}

The motivation for capacitive grading is clear in figure \ref{Figure:No_Foil_Field}. 
The central area of stress is shown in figure \ref{figure:problemfield}.
...
\begin{figure}[!h]
   \centering
   \includegraphics[width = 0.5\textwidth]{./Figures/Simulations/Edited_No_Foils_Final/E_Field_Norm_Close_Centre.png}
