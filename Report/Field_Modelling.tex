...
\begin{figure}[!h]
  \centering
  \subfigure[Geometry]{
    \includegraphics[height = 9cm]{./Figures/Simulations/Edited_No_Foils_Large/Geometry.png} 
	\label{Figure:No_Foil_Large_Geom}
  }
  \subfigure[Extra Fine Mesh]{
    \includegraphics[height = 9cm]{./Figures/Simulations/Edited_No_Foils_Large/Meshing.png} 
	\label{Figure:No_Foil_Large_Mesh}
  }
\subfigure[Normal Electric Field (V/m)]{
    \includegraphics[height = 9cm]{./Figures/Simulations/Edited_No_Foils_Large/Norm_E_Field.png} 
